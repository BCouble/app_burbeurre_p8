"""
Django settings for platform_purbeurre project.
...
SECRET_KEY = 'zrd$2cptcsu-s7q0sx$3ki%fwa^zb9csv4kggt6pe*u9&gj)et'
...
ROOT_URLCONF = 'platform_purbeurre.urls'
...
WSGI_APPLICATION = 'platform_purbeurre.wsgi.application'
